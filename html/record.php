<?php
    ...
    {   
        ...
        {
            if($stmt = $connect->query("DELETE FROM contact WHERE id='$i' "))
            {
...
<html>
    ...
    <form method="post" id="form_record" name="form_record">
    <table width="1000px" border="2">
        ...
        <?php
            ...
            if($stmt = $connect->query("SELECT * FROM contact ORDER BY id DESC"))
            {
                $ctr = 0;
